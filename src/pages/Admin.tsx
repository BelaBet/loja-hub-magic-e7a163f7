...
import { Shield, Search, ExternalLink, Building2, Webhook, FlaskConical, CreditCard, Wrench } from "lucide-react";
    ...
    <AppLayout>
      <div className="space-y-5 max-w-6xl">
        ...
        <div>
          ...
          <Button variant="outline" size="sm" asChild className="ml-2">
            <Link to="/admin/alertas-tecnicos">
              <Wrench className="h-4 w-4 mr-1.5" /> Alertas técnicos
            </Link>
          </Button>
        </div>
